...
/// <summary>
/// Basic container for card controls.
/// </summary>
public partial class CardPanel : ToggleButton
{
    ...
    public CardPanel()
    {
        ...
        _compositor = AppViewModel.Instance.MainWindow.Compositor;
        IsThreeState = false;
    }
    ...
    private void OnActualThemeChanged(FrameworkElement sender, object args) => ApplyShadowAnimation();
