...
/// 书籍信息对话框.
/// </summary>
public sealed partial class BookInformationDialog : CustomDialog, IBookInformationDialog
{
    private readonly IShelfBookViewModel _viewModel;
    ...
    {
        if (data is IShelfBookViewModel vm)
        {
            _viewModel = vm;
        }
    }
