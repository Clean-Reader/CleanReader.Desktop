...
/// 应用日志记录模块.
/// </summary>
public class LoggerToolkit : ILoggerToolkit
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="LoggerToolkit"/> class.
    /// </summary>
    public LoggerToolkit() => Initialize();
    ...
    private void Initialize()
    {
        ...
        _logger = NLog.LogManager.GetLogger("Richasy.CleanReader");
    }
