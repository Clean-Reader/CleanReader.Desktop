...
public partial class ExpanderExDescriptor
{
    ...
    public object Icon
    {
        get => (object)this.GetValue(IconProperty);
    ...
    {
        get => (Visibility)this.GetValue(DescriptionVisibilityProperty);
    ...
    {
        get => (bool)this.GetValue(IsAutoHideIconProperty);
    ...
    {
        get => (double)this.GetValue(AutoHideIconThresholdProperty);
    ...
    {
        get => (double)GetValue(InlineSpacingProperty);
